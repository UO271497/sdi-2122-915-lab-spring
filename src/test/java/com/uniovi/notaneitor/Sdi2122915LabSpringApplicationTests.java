...
@SpringBootTest
class Sdi2122915LabSpringApplicationTests {
    ...
    static String Geckodriver = "C:\\Users\\migue\\OneDrive\\Documentos\\Uniovi\\Tercero segundo cuatri\\SDI\\Practica" +
            "\\sesion06\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
...
// Propiedad: Error.signup.dni.length
    ...
    //PR06B. Prueba del formulario de registro. Constraseña no coincide.
    // Propiedad: Error.signup.passwordConfirm.coincidence
    @Test
    @Order(9)
    public void PR06C() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999912A", "Jose", "Perez", "77777", "77775");
    ...
    public void PR06D() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999913A", "Jose", "Perez", "7777", "77775");
    ...
    public void PR10() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999990A", "1234");
        //Comprobamos que entramos en la pagina privada de Alumno
    ...
    public void PR12() {
        ...
        PO_NavView.clickElement(driver, "id", "marks-menu");
        PO_NavView.clickElement(driver, "free", "/html/body/nav/div/div[1]/ul/li[2]/div/a");


        String checkText2 = "Actualizar";
        List<WebElement> result2 = PO_View.checkElementBy(driver, "text", checkText2);
        Assertions.assertEquals(checkText2,result2.get(0).getText());

        PO_HomeView.clickOption(driver, "logout", "class", "btn btn-primary");
        String checkText3 = "Identifícate";
        List<WebElement> result3 = PO_View.checkElementBy(driver, "text", checkText2);
    ...
    */
    ...
    public void PR14() {
        ...
        PO_PrivateView.clickMarksMenu(driver,"mark/add");
        //Ahora vamos a rellenar la nota. //option[contains(@value, '4')]
        String checkText = "Nota Nueva 1";
        PO_PrivateView.fillFormAddMark(driver, 3, checkText, "8");
        //Esperamos a que se muestren los enlaces de paginación la lista de notas y nos vamos a la pagina 3
    ...
    public void PR15() {
        ...
        //Pinchamos en la opción de menú de Notas: //li[contains(@id, 'marks-menu')]/a
        PO_PrivateView.clickMarksMenu(driver,"mark/list");
